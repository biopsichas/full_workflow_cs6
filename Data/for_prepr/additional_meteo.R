...
stations_df <- data.frame(
  ID = paste0("ID", c(7, 11, 12, 21, 22, 23)),
  Name = c("rad_7", "rad_11", "rad_12", "rad_21", "rad_22", "rad_23"),
  Elevation = c( 150, 150, 150, 150, 150, 150),
  Source = "online",
  Lat = c(46.8, 46.7, 46.8, 46.6, 46.7, 46.8),
  Long = c(16.3, 16.4, 16.4, 16.5, 16.5, 16.5)
) %>%
